...
namespace Drexel.DataSources
{
    ...
    public interface IConfigurable
    {
        ...
        /// <summary>
        /// Returns an <see cref="IBoundConfiguration"/> applicable to this <see cref="IConfigurable"/>.
        /// </summary>
        /// <param name="bindings">
        /// A mapping of <see cref="IConfigurationRequirement"/> to <see cref="object"/>; used by the
        /// <see cref="IConfigurable"/> to produce the <see cref="IBoundConfiguration"/>.
        /// </param>
        /// <returns>
        /// An <see cref="IBoundConfiguration"/> applicable to this <see cref="IConfigurable"/> produced from the supplied
        ...
        /// </exception>
        IBoundConfiguration Configure(IReadOnlyDictionary<IConfigurationRequirement, object> bindings);
    }
}
